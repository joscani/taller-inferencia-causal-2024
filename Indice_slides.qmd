...
date: "2024-09-21 (updated: `r Sys.Date()`)"
#format:  revealjs
...
<li>Consistencia o SUTVA: Qué realmente el análisis conteste a la pregunta causal</li>

<li>Intercambiabilidad</li>

<li>Positividad:</li>

<li>Se podría resumir como "peras con peras" y "manzanas con manzanas".</li>
...
3.  Cuarteto causal
4.  Ejemplo buenos y malos controles

- [Ejemplo dags](ciencia-antes-que-estadistica.html)

## Técnicas {background-color="#23373B"}

Son sólo técnicas, lo importante es lo de antes.Queremos acercarnos a lo que es un RCT, qué se puede hacer desde perspectiva clásica frecuentista.
...
-   Se ha incluido en los ejemplos enfoques bayesianos
...
### [Causal Inference](https://www.hsph.harvard.edu/miguel-hernan/causal-inference-book/): Libro gratuito online
...
### [Mixtape](https://mixtape.scunning.com/): Bastante didáctivo
